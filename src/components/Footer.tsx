...
const column2 = [
  { name: "Doctrines & Beliefs", href: "/doctrines-and-beliefs" },
  { name: "Blog", href: "https://blogs.vertueal.com/theflockofchrist" },
  { name: "Upcoming Events", href: "/" },
  { name: "Locations", href: "/" },
  { name: "Involved Churches", href: "/" },
];
...
export default function Footer() {
  return (
    <footer className="  bg-[#131921] text-neutral-300 dark:bg-[#131921] dark:text-neutral-400">
          ...
          <div className="flex flex-shrink-0 items-center md:pl-0">
            <Link href="/" className="flex items-center gap-3">
              <Image
                ...
                sizes="100vw"
              />
              <h2 className="font-bold text-[#F43F5E]">The Flock Of Christ</h2>
            </Link>
          </div>

          <p className="md:text-sm pt-4 w-auto sm:w-6/12 md:w-6/12 lg:w-8/12">
            Discover The Flock Of Christ, an organization committed to embracing
            the essence of early church believers. Through unity, relational
            intimacy, and a focus on Christ, we cultivate a vibrant community of
            believers dedicated to making a meaningful impact in the world.
            Explore our resources, connect with like-minded individuals, and
            embark on a journey of faith and service. Join us as we strive to
            reflect the love and teachings of Jesus Christ in all that we do.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 p-6 text-center border-t border-neutral-800">
        <span className="text-neutral-300 dark:text-neutral-400 text-sm hover:text-rose-500 dark:hover:text-rose-500 transition duration-300">
